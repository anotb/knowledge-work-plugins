...
Take a consulting engagement from "we just won this work" to "the engagement is running." This covers four things that happen roughly in sequence but overlap in practice: planning the kickoff, mapping stakeholders, designing discovery, and establishing the operating rhythm.
